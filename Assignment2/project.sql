...
INSERT INTO users VALUES ('prachi@gmail.com', '12345678', 'admin');
INSERT INTO users VALUES ('sanika@gmail.com', '12345678', 'admin');
INSERT INTO users VALUES ('sanmati@gmail.com', '12345678', 'admin');
INSERT INTO users VALUES ('pratiksha@gmail.com', '12345678', 'admin');
INSERT INTO users VALUES ('rahul@student.com', 'student123', 'student');
INSERT INTO users VALUES ('aisha@student.com', 'learn2025', 'student');
INSERT INTO users VALUES ('vikram@student.com', 'study7890', 'student');
INSERT INTO users VALUES ('meera@student.com', 'classroom8', 'student');
...
(1, 'Prachi', 'prachi@gmail.com', 101, 9876543210, NULL),
(2, 'Sanika', 'sanika@gmail.com', 102, 9876543211, NULL),
(3, 'Sanmati', 'sanmati@gmail.com', 103, 9876543212, NULL),
(4, 'Pratiksha', 'pratiksha@gmail.com', 104, 9876543213, NULL),
(5, 'Rahul', 'rahul@student.com', 105, 9876543214, NULL),
(6, 'Aisha', 'aisha@student.com', 106, 9876543215, NULL),
(7, 'Vikram', 'vikram@student.com', 107, 9876543216, NULL),
(8, 'Meera', 'meera@student.com', 108, 9876543217, NULL);
...
1) Write a Sql query that will fetch all upcoming courses.
SELECT *
FROM courses
...
(205, 'Blockchain Basics', 'Introduction to blockchain and smart contracts', 6000, '2026-01-15', '2026-03-05', 60);
...
2) Write a Sql query that will fetch all the registered students along with course name
...
+--------+-----------+---------------------+------------+-----------+--------------------+
|      1 | Prachi    | prachi@gmail.com    | 9876543210 |       101 | Web Dev Basics     |
|      2 | Sanika    | sanika@gmail.com    | 9876543211 |       102 | Python Mastery     |
|      3 | Sanmati   | sanmati@gmail.com   | 9876543212 |       103 | Data Science Intro |
|      4 | Pratiksha | pratiksha@gmail.com | 9876543213 |       104 | Java Fullstack     |
|      5 | Rahul     | rahul@student.com   | 9876543214 |       105 | AI Foundations     |
|      6 | Aisha     | aisha@student.com   | 9876543215 |       106 | SQL & Databases    |
|      7 | Vikram    | vikram@student.com  | 9876543216 |       107 | Cybersecurity 101  |
|      8 | Meera     | meera@student.com   | 9876543217 |       108 | Cloud Essentials   |
+--------+-----------+---------------------+------------+-----------+--------------------+

3) Write an SQL query to fetch the complete details of a student (based on their email) along with the details
...
INSERT INTO students VALUES (301, 'Meera', 'meera@student.com', 201, 9876500040, NULL);
...
+--------+-------+-------------------+-----------+------------+--------------------------+-----------+----------------+--------------------------------+------+------------+------------+-------------------+
|    301 | Meera | meera@student.com |       201 | 9876500040 | NULL                     |       201 | Advanced React | Deep dive into React and Hooks | 5000 | 2025-12-20 | 2026-01-31 |                60 |
+--------+-------+-------------------+-----------+------------+--------------------------+-----------+----------------+--------------------------------+------+------------+------------+-------------------+

4) Write an SQL query to retrieve the course details and the list of non-expired videos for a specific student
...
INSERT INTO videos VALUES (301, 201, 'React Hooks', 'Modern React hooks', 'https://youtu.be/react2025', '2025-12-01');
